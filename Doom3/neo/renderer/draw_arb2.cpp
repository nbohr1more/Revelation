...
static	const int	MAX_GLPROGS = 255;
...
void R_LoadARBProgram( int progIndex ) {
	...
	common->Printf( "\n" );
	// output shaders using math instead of cubemaps
	if( r_splitShaders.GetBool() ) {
		// need to strip the extension for the shader output.
