...
const char *r_rendererArgs[] = { "best", "arb", "arb2", "glsl", "nv10", "nv20", "r200", NULL };
...
idCVar r_useTurboShadow( "r_useTurboShadow", "0", CVAR_RENDERER | CVAR_BOOL, "use the infinite projection with W technique for dynamic shadows" );
...
idCVar r_useOptimizedShadows( "r_useOptimizedShadows", "0", CVAR_RENDERER | CVAR_BOOL, "use the dmap generated static shadow volumes" );
...
static void R_CheckPortableExtensions( void ) {
	...
	if( glewIsSupported( "GL_EXT_shared_texture_palette" ) ) {
		common->Printf( "...initializing GL_EXT_shared_texture_palette\n" );
		glConfig.sharedTexturePaletteAvailable = true;
	} else {
		common->Printf( "GL_EXT_shared_texture_palette: not availiable!\n" );
